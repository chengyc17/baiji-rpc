...
public class BaijiGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "SINGLE_LINE_COMMENT", "MULTI_LINE_COMMENT", 
			"STRING_LITERAL", "INTEGER_LITERAL", "IDENTIFIER", "PACKAGE_IDENTIFIER", 
			"WS"
		};
	}
	...
	public BaijiGrammarLexer(CharStream input) {
		super(input);
